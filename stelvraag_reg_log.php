<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="col-md-4 col-md-offset-1" style="background-color: #eee; padding: 20px;">
                        <p><b>Inloggen of <a href="registreren.php">registreren</a></b></p>
                        <form method="POST" action="stelvraag.php">
            ...
            <div class="col-md-4 col-md-offset-1" id="registreren_container">
                <?php if($melding == '') : ?>       
